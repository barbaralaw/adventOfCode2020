...
function aocDay2Pt2(data) {
  let validCount = 0;
  for (let i=0; i<data.length; i++) {
    let firstIndx = data[i][0]-1
    let secondIndx = data[i][1]-1
    let key = data[i][2][0]
    if ((data[i][3][firstIndx] === key || data[i][3][secondIndx] === key) && data[i][3][firstIndx] != data[i][3][secondIndx]) {
      validCount++
    }
  }
  return validCount
...
aocDay1Pt1(inputDay1)   // 787776
aocDay1Pt2(inputDay1)   // 262738554
aocDay2Pt1(inputDay2)   // 600
aocDay2Pt2(inputDay2)   // 245
